...
|---|---|---|
| **Gemini** | Iegūt bezmaksas API atslēgu aistudio.google.com | ~2 min · ~$0,15 uz stundu avota |
...
| **Gemini** | Precīzāks humora un vizuālais spriedums (T2 caurlaide) | ~2 min · ~$0,15 uz stundu avota |
