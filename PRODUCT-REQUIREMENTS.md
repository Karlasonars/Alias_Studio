...
**Versija:** 1.13 · **Datums:** 2026-09-06 · **Statuss:** Vārti un higiēna ieviesti; gatavs pirmajam agentam
...
*Pieņemšanas kritēriji:*
- Lietotnes **pašas** dizains, pazīstamajā sociālā ieraksta kartītes formā, bet ar **lietotāja paša kanālu**: **necaurspīdīga balta** kartīte ar noapaļotiem stūriem un mīkstu ēnu kadra vidū — tā sēž virs raiba fona un uzvar, nevis saplūst ar to —, gandrīz melns teksts, no augšas uz leju: galvenes rinda (liels avatāra aplis kreisajā pusē, kanāla nosaukums treknrakstā tam blakus), stāsta virsraksts **teikuma rakstībā** (ne lielajiem burtiem, lai kāds būtu preseta iestatījums) preseta fontā ar izmēru pēc garuma, un apakšējā rinda tur, kur sociālā kartīte liktu iesaisti: **kaila sirds glifa** kreisajā pusē, **kaila dalīšanās glifa** tai blakus un stāsta **ilgums** (m:ss), ko `narrate` posms jau zina. Horizontālas līnijas nav. Viss paliek salasāms 1080×1920 ar garāko virsrakstu. Forma ir vispārīga saskarne, būvēta pēc apraksta — neviena trešās puses dizaina fails netiek reproducēts (AGPL produktā tas būtu licences jautājums, kas mums nav vajadzīgs).
