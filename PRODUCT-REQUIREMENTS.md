...
**Versija:** 1.14 · **Datums:** 2026-09-17 · **Statuss:** Vārti un higiēna ieviesti; gatavs pirmajam agentam
...
*Pieņemšanas kritēriji:*
- Lietotnes **pašas** dizains, pazīstamajā sociālā ieraksta kartītes formā, bet ar **lietotāja paša kanālu**: **necaurspīdīga balta** kartīte ar noapaļotiem stūriem un mīkstu ēnu kadra vidū — tā sēž virs raiba fona un uzvar, nevis saplūst ar to —, gandrīz melns teksts, no augšas uz leju: galvenes rinda (liels avatāra aplis kreisajā pusē, kanāla nosaukums treknrakstā tam blakus), viens teksta bloks — stāsta virsraksts **treknrakstā**, **teikuma rakstībā** (ne lielajiem burtiem, lai kāds būtu preseta iestatījums) preseta fontā ar izmēru pēc garuma, vienmēr lielāks par kanāla nosaukumu, un tieši zem tā stāsta **pamatteksta sākums** tajā pašā fontā, kas aizpilda kartīti līdz apakšējās rindas joslai: blīvums ir āķis — teksta siena, ko skatītājs sāk lasīt, pirms izlemj pārslīdēt —, un garāks stāsts tiek nogriezts **vārda robežā** ar daudzpunkti, nekad vārda vidū, nekad rakstzīmes vidū, nekad apakšējā rindā. Kartītes augstums nemainās, un tās laiks ekrānā paliek piesaistīts ierunājumam, ne pamatteksta garumam; teksts nāk no darba mapes `story.txt`, bez jauna iestatījuma, un rindas kartīte lauž pati ar fonta īstajiem platumiem (`captions/font_metrics.py`), lai zinātu, kur vieta beidzas, pirms `ffmpeg` ko zīmē — un apakšējā rinda tur, kur sociālā kartīte liktu iesaisti: **kaila sirds glifa** kreisajā pusē, **kaila dalīšanās glifa** tai blakus un stāsta **ilgums** (m:ss), ko `narrate` posms jau zina. Horizontālas līnijas nav. Viss paliek salasāms 1080×1920 ar garāko virsrakstu. Forma ir vispārīga saskarne, būvēta pēc apraksta — neviena trešās puses dizaina fails netiek reproducēts (AGPL produktā tas būtu licences jautājums, kas mums nav vajadzīgs).
- **Bez svešas zīmolvedības, bez citas platformas logo vai vārdzīmes, bez izdomāta lietotājvārda, bez verificēta konta nozīmītes, bez apbalvojumu ikonām, bez izdomātiem balsojumu, komentāru, dalīšanas vai skatījumu skaitļiem.** Glifs ir dekorācija, skaitlis blakus tam — apgalvojums: kaila sirds vai dalīšanās ikona ir atļauta un ir šī dizaina daļa, bet jebkāds skaitlis pie tās — "99+", "1.2k", viens cipars — ne, tāpat kā nozīmīte, kas apgalvo, ka platforma šo kontu verificējusi. Tas ir produkta ierobežojums, ne stila izvēle un ne lietotāja izvēle: rīks, kas ģenerē citas platformas hromu ar safabricētiem iesaistes skaitļiem, ir viltotu ierakstu ģenerators. Ja formātam šķiet, ka tas to prasa — nē: ne kā iestatījums, ne kā līdzīgs glifs. Apakšējā rinda nes īsto ilgumu tieši tāpēc, lai izkārtojums nevienu nekārdinātu to aizpildīt ar safabricētu iesaisti: katrs skaitlis uz kartītes ir tāds, ko darbs pats izrēķinājis.
- Avatāra aplis ir aizpildīts ar lietotāja **avatāra attēlu** — `story.avatar`, atsevišķu PNG ar savu izvēlnieku ([E20-F06](#e20--stāstu-režīms)), importētu caur to pašu palīgu, ko ūdenszīme jau lieto ([E19-F02](#e19--pārklājumi-uz-klipa)), savā mapē `PUBLIKCLIP_HOME/avatars`. Apļa maska, centrēti apgriezts kvadrātā. Ūdenszīme **netiek** izmantota kā avatārs: tas bija pagaidu risinājums versijā, ko neviens nav palaidis, un "kāpēc mana ūdenszīme rādās kā profila attēls" ir stāvoklis, par ko nevienam nebūtu jādomā. Divi stāvokļi, paredzami: avatārs, vai kanāla nosaukuma **iniciālis** uz preseta akcenta krāsas (§5.9) — nekad avārija, nekad tukšs aplis. Bez nosaukuma un bez attēla — galvenes rindas nav.
- Kanāla nosaukums un avatārs ir kanāla identitāte — iestatīti vienreiz Iestatījumos, panelī tikai pārrakstāmi vienam darbam ([E20-F06](#e20--stāstu-režīms)); abi četrās vietās (§5.1), ar `--channel-name` un `--avatar` uz `run`, `resume` un `jobs create`, abi renderēšanas pirkstu nospiedumā. Nosaukuma vai attēla maiņa pārrenderē; nekā nemaiņa — ne.
...
**E20-F06 · Kanāla identitāte — avatārs un nosaukums, kas saglabājas** · `P1` · P1, P2

*Pieņemšanas kritēriji:*
- Kanāla identitāte ir pāris — **nosaukums un avatārs** — un tā dzīvo **Iestatījumos**, ne panelī: to iestata vienreiz kanālam, ne katram darbam. Panelis abus rāda aizpildītus no šiem noklusējumiem un var tos pārrakstīt vienam darbam — tā pati forma, kāda ūdenszīmei jau ir. Paneļa pārrakstīšana iestatījumu **nemaina**.
- `story.avatar` ir importēts attēls, savs iestatījums, savs izvēlnieks — arī Iestatījumu panelī (attēla tipa vadīkla: izvēlēties, notīrīt). `story.channel_name` ir Iestatījumu vadīkla, lai tas saglabājas; panelis patur savu lauku, aizpildītu.
- Imports **atkārtoti izmanto ūdenszīmes palīgu**, parametrizētu ar mapi: izvēlēties failu, nokopēt to `PUBLIKCLIP_HOME/avatars` ar attīrītu nosaukumu, saglabāt ceļu, un faila sha256 renderēšanas pirkstu nospiedumā — tās pašas trīs lietas, ko ūdenszīme jau dara. Viens palīgs, ne otra kopija.
- Atkāpšanās secība: **avatārs, tad kanāla iniciālis.** Ūdenszīme par avatāru vairs **netiek** izmantota — apzināta noņemšana. Bez avatāra un bez nosaukuma — galvenes rindas nav, kā līdz šim.
- Avatāra sha256 ir renderēšanas pirkstu nospiedumā **atsevišķi** no ūdenszīmes: attēla nomaiņa zem tā paša faila nosaukuma pārrenderē (§4, 1. noteikums), un kartīte un ūdenszīme nekad nevar paņemt viena otras failu. Kartītes zīmējuma versija pacelta vēlreiz; katrs stāsta darbs pārrenderē savu kartīti vienreiz.
- Jaunas lēmumu žurnāla rindas nav: tas labo E20-F05 izvēli, nevis atceļ produkta lēmumu.
...
| 1.14 | 2026-09-17 | **[E20-F05](#e20--stāstu-režīms) aizpildījums — kartīte pilna ar stāstu.** Zem virsraksta tajā pašā fontā stāsta pamatteksta sākums, kas aizpilda kartīti līdz apakšējās rindas joslai un garākam stāstam tiek nogriezts vārda robežā ar daudzpunkti; virsraksts un pamatteksts ir viens bloks, virsraksts treknrakstā un lielāks par kanāla nosaukumu. Kartītes augstums un laiks ekrānā nemainās; teksts nāk no darba `story.txt`, bez jauna iestatījuma; rindas lauž pati kartīte ar fonta īstajiem platumiem (`captions/font_metrics.py`). Jauna prasības ID nav; zīmējuma versija pacelta. |
| 1.13 | 2026-09-06 | **[E20-F05](#e20--stāstu-režīms) izskata precizējums — kartīte lasās kā atsauces kartīte.** Necaurspīdīga balta kartīte ar mīkstu ēnu, gandrīz melns teksts, virsraksts teikuma rakstībā, lielāks avatārs un treknraksta nosaukums, bez horizontālās līnijas; apakšējā rinda — kaila sirds glifa, kaila dalīšanās glifa un ilgums. Aizliegums paplašināts vārdā: verificēta konta nozīmīte un apbalvojumu ikonas, un glifa/skaitļa robeža (glifs — dekorācija, skaitlis — apgalvojums) ierakstīta vienā teikumā. Jauna prasības ID nav; zīmējuma versija pacelta. |
| 1.12 | 2026-09-06 | **Jauna [E20-F06](#e20--stāstu-režīms) — kanāla identitāte: savs avatārs un nosaukums, kas saglabājas.** Avatārs ir savs importēts attēls (`story.avatar`, caur ūdenszīmes importa palīgu savā mapē, ar savu sha256 pirkstu nospiedumā), ne ūdenszīme — E20-F05 pagaidu risinājums apzināti noņemts; atkāpšanās ir avatārs, tad iniciālis. Nosaukums un avatārs dzīvo Iestatījumos (attēla tipa vadīkla), panelis tos rāda aizpildītus un var pārrakstīt vienam darbam, iestatījumu nemainot. [E20-F05](#e20--stāstu-režīms) kritēriji par avatāru pārrakstīti; aizliegums pret svešu zīmolvedību un izdomātiem skaitļiem paliek. Zīmējuma versija pacelta vēlreiz. Jaunas lēmumu žurnāla rindas nav. |
